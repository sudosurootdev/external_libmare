...
MARE_CXX_FLAGS :=   -std=c++11  -pipe -W -Wall -Werror=return-type -Wall -Wextra -Weffc++ -Woverloaded-virtual -Wold-style-cast -Wshadow -Wnon-virtual-dtor -Wformat-nonliteral -Wmissing-include-dirs -Wswitch-enum -Wno-lambda-extensions -frtti -fexceptions -DMARE_ENABLE_CHECK_API_DETAILED -O0 -g
ifeq (1,1)
  MARE_HAVE_GPU := 1
