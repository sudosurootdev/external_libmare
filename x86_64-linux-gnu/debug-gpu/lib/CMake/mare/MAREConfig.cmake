...
set(MARE_LIBS ${MARE_LIBS} /usr/lib/x86_64-linux-gnu/libOpenCL.so)
...
list(APPEND MARE_INCLUDE_DIRS /usr/include)
set(MARE_LIBRARIES ${MARE_LIBS})
set(MARE_CXX_FLAGS "  -std=c++11  -pipe -W -Wall -Werror=return-type -Wall -Wextra -Weffc++ -Woverloaded-virtual -Wold-style-cast -Wshadow -Wnon-virtual-dtor -Wformat-nonliteral -Wmissing-include-dirs -Wswitch-enum -Wno-lambda-extensions -frtti -fexceptions -DMARE_ENABLE_CHECK_API_DETAILED -O0 -g")
...
if(MSVC)
  ...
  set(CMAKE_CXX_FLAGS_DEBUG           "${CMAKE_CXX_FLAGS_DEBUG}   -std=c++11  -pipe -W -Wall -Werror=return-type -Wall -Wextra -Weffc++ -Woverloaded-virtual -Wold-style-cast -Wshadow -Wnon-virtual-dtor -Wformat-nonliteral -Wmissing-include-dirs -Wswitch-enum -Wno-lambda-extensions -frtti -fexceptions -DMARE_ENABLE_CHECK_API_DETAILED")
