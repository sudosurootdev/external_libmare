...
//marshalling of mare types to ocl types.
...
//Each mare device attribute will have a return type (type)
//and a cl_name which corresponds to the ocl attribute.
//Given a mare device attribute, it should be bound to a return type
